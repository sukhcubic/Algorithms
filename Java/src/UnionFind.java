...
public class UnionFind {
	...
	public static void main(String args[]) {
		...
		System.out.println(ds.findRoot(1));
		System.out.println(ds.findRoot(2));
		System.out.println(ds.findRoot(3));
		System.out.println(ds.findRoot(4));
		System.out.println(ds.findRoot(5));
		System.out.println(ds.findRoot(6));
		System.out.println(ds.findRoot(7));
	}
}